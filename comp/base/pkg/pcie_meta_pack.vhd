...
-- 168 to 168     TPH_PRESENT     Transaction Processing Hint (TPH) present flag - Xilinx FPGA only
-- 169 to 170     TPH_TYPE        The PH field associated with the hint - Xilinx FPGA only
-- 171 to 171     TPH_IND_TAG_EN  Enables Indirect Tag instead of using TPH_ST_TAG directly - Xilinx FPGA only
-- 172 to 179     TPH_ST_TAG      The Steering Tag associated with the hint - Xilinx FPGA only
-- ============== =============== ==============================================
--
...
package pcie_meta_pack is
    ...
    constant PCIE_META_TPH_IND_TAG_EN_W  : natural := 1;
    ...
    constant PCIE_RQ_META_TPH_PRESENT_O    : natural := PCIE_RQ_META_LBE_O            + PCIE_META_LBE_W;
    constant PCIE_RQ_META_TPH_TYPE_O       : natural := PCIE_RQ_META_TPH_PRESENT_O    + PCIE_META_TPH_PRESENT_W;
    constant PCIE_RQ_META_TPH_IND_TAG_EN_O : natural := PCIE_RQ_META_TPH_TYPE_O       + PCIE_META_TPH_TYPE_W;
    constant PCIE_RQ_META_TPH_ST_TAG_O     : natural := PCIE_RQ_META_TPH_IND_TAG_EN_O + PCIE_META_TPH_IND_TAG_EN_W;

    constant PCIE_RQ_META_WIDTH    : natural := PCIE_RQ_META_TPH_ST_TAG_O + PCIE_META_TPH_ST_TAG_W;
    ...
    subtype PCIE_RQ_META_TPH_PRESENT    is natural range PCIE_RQ_META_TPH_PRESENT_O    + PCIE_META_TPH_PRESENT_W    -1 downto PCIE_RQ_META_TPH_PRESENT_O;
    subtype PCIE_RQ_META_TPH_TYPE       is natural range PCIE_RQ_META_TPH_TYPE_O       + PCIE_META_TPH_TYPE_W       -1 downto PCIE_RQ_META_TPH_TYPE_O;
    subtype PCIE_RQ_META_TPH_IND_TAG_EN is natural range PCIE_RQ_META_TPH_IND_TAG_EN_O + PCIE_META_TPH_IND_TAG_EN_W -1 downto PCIE_RQ_META_TPH_IND_TAG_EN_O;
    subtype PCIE_RQ_META_TPH_ST_TAG     is natural range PCIE_RQ_META_TPH_ST_TAG_O     + PCIE_META_TPH_ST_TAG_W     -1 downto PCIE_RQ_META_TPH_ST_TAG_O;
